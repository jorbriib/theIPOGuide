...
type Controller struct {
	service application.IpoService
}

func NewController(service application.IpoService) Controller {
...
func (c Controller) GetSimilarIpos(writer http.ResponseWriter, request *http.Request) {
	...
	response, err := c.service.GetSimilarIPOs(query)
	if err != nil {
		writer.WriteHeader(http.StatusInternalServerError)
		return
	}
