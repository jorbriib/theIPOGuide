                                ...
                                <div className="menu-fullwidth">
                                    <div className="logo-wrapper order-lg-0 order-sm-1">
                                        <div className="logo logo-top">
                                            <NavLink to="/"><img src="/assets/images/logo.png" alt="logoImage" className="img-fluid" /></NavLink>
                                        </div>
                                        ...
                                        <div className="search-wrapper">
                                            ...
                                            <div className="search-categories">
                                                <ul className="list-unstyled">
                                                    <li><a href="/"><span className="la la-glass bg-danger"></span> Find IPOs</a></li>
                                                    <li><a href="/login"><span className="la la-glass bg-danger"></span> Login</a></li>
                                                </ul>
                                            </div>
