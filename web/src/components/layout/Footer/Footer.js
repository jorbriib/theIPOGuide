                                ...
                                <div className="col-lg-12 col-sm-12">
                                    <div className="widget widget_pages">
                                        ...
                                        <ul className="list-unstyled">
                                            ...
                                            <li className="page-item"><NavLink to="/policy">Privacy Policy</NavLink></li>
                                        </ul>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div className="row">
                                <div className="col-lg-12">
                                    <div className="footer-bottom--content">
                                        <NavLink to="/" className="footer-logo"><img src="./assets/images/logo-black.png" alt="theIPOguide" /></NavLink>
