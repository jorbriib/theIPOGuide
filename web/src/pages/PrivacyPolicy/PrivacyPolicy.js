    ...
    <Fragment>
      ...
      <section className="header-breadcrumb bgimage overlay overlay--dark">
        <div className="bg_image_holder" style={backgroundImage}>
          <img src="/assets/images/wallstreet-bull.jpg" alt="Privacy Policy" />
        </div>
              ...
              <div className="atbd_content_module atbd_listing_details">
                <div className="atbd_content_module__tittle_area">
                  <div className="atbd_area_title">
                    <h4>
                      <span className="la la-legal"></span>Privacy Policy for
                      theIPOguide
                    </h4>
                  </div>
                </div>
                <div className="atbdb_content_module_contents">
                  <p>
                    At theIPOguide, accessible from theIPOguide.com, one of our
                  ...
                  <p>
                    ...
                    information that they shared and/or collect in theIPOguide.
                  ...
                  <p>
                    theIPOguide follows a standard procedure of using log files.
                  ...
                  <p>
                    Like any other website, theIPOguide uses 'cookies'. These
                  ...
                  <p>
                    ...
                    each of the advertising partners of theIPOguide.
                  </p>
                  ...
                  <p>
                    ...
                    theIPOguide, which are sent directly to users' browser. They
                  ...
                  <p>
                    Note that theIPOguide has no access to or control over these
                  ...
                  <p>
                    theIPOguide's Privacy Policy does not apply to other
                  ...
                  <p>
                    theIPOguide does not knowingly collect any Personal
