  ...
  return (
    <Fragment>
      ...
      <section className="header-breadcrumb bgimage overlay overlay--dark">
        ...
        <BreadcrumbWrapper title="" onlyTitle={true} />
      </section>
      {/* Header section end */}

      <section className="directory_listiing_detail_area single_area section-bg section-padding">
              ...
              <div className="atbd_content_module atbd_listing_details">
                <div className="atbd_content_module__tittle_area">
                  <div className="atbd_area_title">
                    <h4>
                      <span className="la la-legal"></span>Terms and Conditions
                    </h4>
                  </div>
                </div>
                <div className="atbdb_content_module_contents">
                  <p>Welcome to theIPOguide!</p>
                  ...
                  <p>
                    ...
                    and conditions. Do not continue to use theIPOguide if you do
                  ...
                  <p>
                    ...
                    interchangeable and therefore as referring to same. Our
                  ...
                  <p>
                    We employ the use of cookies. By accessing theIPOguide, you
                    agreed to use cookies in agreement with the theIPOguide's
                    Privacy Policy.
                  </p>
                  ...
                  <p>
                    Unless otherwise stated, theIPOguide and/or its licensors
                    own the intellectual property rights for all material on
                    theIPOguide. All intellectual property rights are reserved.
                    You may access this from theIPOguide for your own personal
                  ...
                  <p>You must not:</p>
                  <ul>
                    <li>Republish material from theIPOguide</li>
                    <li>Sell, rent or sub-license material from theIPOguide</li>
                    <li>
                      Reproduce, duplicate or copy material from theIPOguide
                    </li>
                    <li>Redistribute content from theIPOguide</li>
                  </ul>
                  ...
                  <p>
                    theIPOguide reserves the right to monitor all Comments and
                  ...
                  <p>
                    You hereby grant theIPOguide a non-exclusive license to use,
                  ...
                  <p>
                    ...
                    compensates the absence of theIPOguide; and (d) the link is
                  ...
                  <p>
                    ...
                    inform us by sending an e-mail to theIPOguide. Please
                  ...
                  <p>
                    No use of theIPOguide's logo or other artwork will be
